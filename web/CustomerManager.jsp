                ...
                <tbody class="align-middle">
                    <c:forEach items="${allCustomers}" var="customer">
                        <tr>
                            ...
                            <td class="align-middle">
                                <c:if test="${customer.banned == 1}">
                                    <a href="manageCustomer?service=unban&id=${customer.id}"><button class="btn btn-sm btn-success">
                                            Unban
                                        </button></a>
                                    </c:if>
                                <c:if test="${customer.banned == 0}">
                                    <a href="manageCustomer?service=ban&id=${customer.id}"><button class="btn btn-sm btn-primary">
